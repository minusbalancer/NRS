...
/* 10:   */   
/* 11:   */   public JSONObject processJSONRequest(JSONObject paramJSONObject, Peer paramPeer)
/* 12:   */   {
...
/* 17:21 */       if ((localPeer.getBlacklistingTime() == 0L) && (localPeer.getAnnouncedAddress().length() > 0) && (localPeer.getState() == Peer.State.CONNECTED) && (localPeer.shareAddress())) {
