...
/*  15:    */ 
/*  16:    */ public final class CancelAskOrder
/*  17:    */   extends HttpRequestHandler
/*  18:    */ {
/*  19: 30 */   static final CancelAskOrder instance = new CancelAskOrder();
/*  20:    */   
...
/*  78:    */     
/*  79: 85 */     Order.Ask localAsk = Order.Ask.getAskOrder(localLong1);
/*  80: 86 */     if ((localAsk == null) || (!localAsk.getAccount().getId().equals(localLong3))) {
...
/*  88: 96 */     Attachment.ColoredCoinsAskOrderCancellation localColoredCoinsAskOrderCancellation = new Attachment.ColoredCoinsAskOrderCancellation(localLong1);
/*  89: 97 */     Transaction localTransaction = Transaction.newTransaction(j, s, arrayOfByte, Genesis.CREATOR_ID, 0, i, localLong2, localColoredCoinsAskOrderCancellation);
/*  90:    */     
